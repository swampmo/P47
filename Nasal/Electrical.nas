...
var alternator1 = Alternator.new(0,"controls/electric/engine/generator","engines/engine/rpm",100.0,28.0,60.0);
...
init_switches = func() {
    var tprop=props.globals.initNode("controls/electric/ammeter-switch",1,"BOOL");
    tprop=props.globals.initNode("controls/lighting/instrument-lights",0,"BOOL");
    tprop=props.globals.initNode("controls/electric/engine/generator",1,"BOOL");
